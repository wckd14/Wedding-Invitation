...
var countDownDate = new Date("Jan 27, 2022 10:00:00").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='days'>"+days+"</div><div class='hours'>"+ hours + "</div><div class='minutes'>"+ minutes + "</div><div class='seconds'">+seconds+"</div>";
...
console.log('\n\n%c SAVE THE DATE: 27th Jan, 2022!', styles);
...
$('#answer-example-share-button').on('click', () => {
    if (navigator.share) {
      navigator.share({
          ...
          text: 'Wedding Invitation | Jan 27 | Sree Narayana Hall, Vatakara',
          url: 'https://nonavivek.life/',
        })
